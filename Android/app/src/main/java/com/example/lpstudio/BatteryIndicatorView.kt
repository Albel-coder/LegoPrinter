...
class BatteryIndicatorView @JvmOverloads constructor(
    ...
    private suspend fun updateBattery() {
        ...
        try {
            // Request a battery level update
            val requestSuccess = controller.requestBatteryLevel()
            ...
            if (requestSuccess) {
                ...
                val level = controller.batteryLevel

                // Check the freshness of the data
                val isFresh = controller.isBatteryLevelFresh(10)
